...
<style scoped>
.native-home{padding:10px 14px calc(76px + env(safe-area-inset-bottom))}
.home-heading{margin:18px 2px 9px}.home-heading:first-child{margin-top:8px}.home-heading h2{font-weight:700;letter-spacing:0}
.home-functions,.home-function-picker,.business-board,.home-todos{border:1px solid color-mix(in srgb,var(--app-line) 72%,transparent);border-radius:12px;box-shadow:var(--app-shadow)}
